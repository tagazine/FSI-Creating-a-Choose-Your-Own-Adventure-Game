...
let firstAnswer = window.prompt('Do you head left or right?')
    if(firstAnswer === 'left'){
        ...
        let secondAnswer = window.prompt(`I do not understand.`)
}
...
// Second Answer
    if(secondAnswer === 'Follow'){
        ...
        let thirdAnswer = window.prompt(`I do not understand.`)
}
...
// Third Answer
    if(thirdAnswer === 'Stay'){
        ...
        let fourtAnswer = window.alert(`You pick the flower and bring it home, and all marvel at its brilliance. However, over time it fades and eventually crumbles to dust.`)
    }
